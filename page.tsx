...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4 py-24 text-white md:py-32 lg:py-40">
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute left-1/4 top-1/4 h-64 w-64 rounded-full bg-indigo-400 blur-[120px]"></div>
          <div className="absolute right-1/4 top-1/2 h-64 w-64 rounded-full bg-slate-400 blur-[120px]"></div>
          <div className="absolute bottom-1/4 left-1/2 h-64 w-64 rounded-full bg-slate-500 blur-[120px]"></div>
        </div>
        ...
        <div className="container relative z-10 max-w-5xl">
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-6">
              <Button
                size="lg"
                className="h-14 rounded-xl bg-white px-8 text-lg font-medium text-slate-900 hover:bg-white/90"
              >
                View MVP <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                className="h-14 rounded-xl border border-white/30 bg-white/80 px-8 text-lg font-medium text-slate-900 backdrop-blur-sm hover:bg-white"
              >
                Become a Mentor
              </Button>
              <Button
                size="lg"
                className="h-14 rounded-xl bg-white/80 px-8 text-lg font-medium text-slate-900 backdrop-blur-sm hover:bg-white"
              >
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="relative aspect-video overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
              <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/40 opacity-0 transition-opacity duration-300 hover:opacity-100">
                <Button
                  size="lg"
              ...
              <video controls className="h-full w-full object-cover" poster="/placeholder.svg?height=720&width=1280">
                <source src="/videos/proco-demo.mov" type="video/quicktime" />
        ...
        <div className="container">
          <div className="mx-auto max-w-5xl">
            <div className="mb-16 text-center">
              ...
              <h2 className="text-4xl font-bold md:text-5xl">Real People, Real Feedback</h2>
              <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">
                We went beyond friends and family to collect honest feedback from real potential users
              </p>
            </div>
            ...
            <div className="grid gap-12 md:grid-cols-2">
              <div className="relative overflow-hidden rounded-2xl bg-slate-900 shadow-xl">
                <div className="absolute inset-0 z-0 opacity-30">
                  <div className="absolute left-1/3 top-1/3 h-32 w-32 rounded-full bg-rose-500 blur-[50px]"></div>
                </div>
              ...
              <div className="space-y-6">
                {[
                  { stat: "95%", desc: "of respondents want better mentorship options", icon: Users },
                  { stat: "89%", desc: "find current platforms inadequate for mentorship", icon: XCircle },
                  { stat: "78%", desc: "would use a dedicated mentorship platform", icon: CheckCircle },
                ].map((item, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-6 rounded-xl border border-slate-200 bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-xl"
                  >
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  name: "Natalie R.",
                  role: "Mentor, UX Lead at a HealthTech Startup",
                  image: "/placeholder.svg?height=100&width=100",
                  color: "bg-slate-800",
                },
                ...
                >
                  <CardContent className="p-0">
                    <div className="relative h-3">
                      <div className={`absolute inset-x-0 top-0 h-3 w-full ${testimonial.color}`}></div>
                    </div>
        ...
        <div className="container">
          ...
          <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
            ...
            {[
              ...
              <div key={index} className="grid grid-cols-3 border-b border-slate-200 last:border-0">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-24 text-white">
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="absolute left-1/4 top-1/4 h-64 w-64 rounded-full bg-slate-400 blur-[100px]"></div>
          <div className="absolute right-1/4 bottom-1/4 h-64 w-64 rounded-full bg-slate-500 blur-[100px]"></div>
        </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-24 text-white">
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="absolute left-1/3 top-1/3 h-64 w-64 rounded-full bg-slate-400 blur-[100px]"></div>
          <div className="absolute right-1/3 bottom-1/3 h-64 w-64 rounded-full bg-slate-500 blur-[100px]"></div>
        </div>
        ...
        <div className="container relative z-10 text-center">
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-4">
              <Button
                size="lg"
                className="h-16 rounded-xl bg-white px-8 text-lg font-medium text-slate-900 hover:bg-white/90"
              >
                View MVP <ExternalLink className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                className="h-16 rounded-xl border border-white/30 bg-white/80 px-8 text-lg font-medium text-slate-900 backdrop-blur-sm hover:bg-white"
              >
                Become a Mentor <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
              <Button
                size="lg"
                className="h-16 rounded-xl border border-white/30 bg-white/80 px-8 text-lg font-medium text-slate-900 backdrop-blur-sm hover:bg-white"
